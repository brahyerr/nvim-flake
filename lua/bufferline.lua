...
vim.keymap.set('n', '<leader>bw', ':BufferLinePickClose<CR>')
vim.keymap.set('n', '<leader>bqq', ':BufferLineCloseLeft<CR>')
vim.keymap.set('n', '<leader>bee', ':BufferLineCloseRight<CR>')
